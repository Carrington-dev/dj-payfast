...
def test_signature():
    ...
    merchant_id = config('merchant_id', "101222")  # Your merchant ID
    merchant_key = config('merchant_key', "4553333")  # Your merchant key
    passphrase = config('passphrase', "y656hojHj")  # Your passphrase
